...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#e8f0ff,_#f7f9fc_45%,_#eef3fb)] text-[#0B2C6E]">
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-xs text-[#0B2C6E]/55">
                  Inspect call communication written by the server.
                </p>
              </div>
              <button
                type="button"
                onClick={() => setIsLogsOpen(true)}
                className="inline-flex items-center gap-1.5 rounded-xl bg-[#0B2C6E] px-3 py-2 text-xs font-semibold text-white"
              >
      ...
      <LogsPanel open={isLogsOpen} onClose={() => setIsLogsOpen(false)} />
